...
### A3b. Proje Adı: tam ad yazılmalı

Kimlik alanındaki ad yalnızca "Denetci.AI"dır. Projenin ne yaptığını ve yapay zekâ niteliğini tek satırda gösteren tam ad yazılmalıdır:

> **Denetci.AI: Denetçi Rolünde Nöro-Sembolik Yerel Yapay Zekâ**

Ad kısa ve soyut tutulmuştur: mevzuat ve teşvik ayrıntısı Proje Özeti'nde zaten vardır, adın taşıması gereken tek şey mimarinin kendisidir (denetçi rolü ve nöro-sembolik yaklaşım). Daha yalın bir alternatif: "Denetci.AI: Denetçi Rolünde Yerel Yapay Zekâ Sistemi".

Ad değiştiğinde başvuru üst yazısı ("... isimli projemizi 4691 sayılı kanun kapsamında...") aynı yazımı gösterir. Marka tescil başvurusu kısa ad olan "Denetci.AI" için yapılır; adın devamı tanımlayıcı alt başlıktır, marka değildir.
