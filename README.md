...
| **[`portal-v8-hakem-duzeltme-raporu.md`](portal-v8-hakem-duzeltme-raporu.md)** | **Hakem toplantısı sonrası düzeltme listesi (portal çıktısı v8, 25.09.2026).** Hakemin üç notu (yazım hataları, 7 M ₺ bütçenin metinlerde farklı geçmesi, 1-4 milyar modelin "≤30 sn" ölçütünün ucunun açık olması) sayfa ve alan bazında: şu an yazan, yerine yazılacak. Ek olarak eski sürümden kalan farklar, iki karar maddesi (ekip 4/6 kişi, portal iş gücü alanlarının hesabı) ve PDF üzerinde yapılacak son kontrol araması. |
