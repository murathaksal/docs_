...
| Belge | İçerik |
|---|---|
| **[`denetci-proje-bilgi-formu.md`](denetci-proje-bilgi-formu.md)** | **ANA BELGE.** İstanbul Medeniyet Üniversitesi Teknopark Proje Bilgi Formu (A-R-01224) başlıklarına göre doldurulmuş, portala aktarıma hazır başvuru içeriği. Proje: **Denetci**; 12 ay / 39 adam-ay / 7,0 M TL; kapsam 5746 + 4691; nöro-sembolik yapay zekâ sistemi olarak çerçevelenmiş dört araştırma sorusu (üçü yapay zekâ bileşenine, biri sembolik kural tabanına ait); yapay zekâ denetçi rolünde dar kapsamlı yerel model olarak konumlanır (hesabı motor yapar, bulguyu model inceler, kararı insan verir). |
