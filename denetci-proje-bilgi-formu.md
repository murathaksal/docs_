...
Mevzuat uyum yazılımı; deterministik hesaplama motoru; 5746 sayılı Kanun Ar-Ge teşvikleri; 4691 sayılı Kanun istisnaları; zaman-farkındalıklı kural sürümleme; geçmiş beyan mutabakatı; kök-neden teşhisi; dar kapsamlı dil modeli denetimli ince ayarı (SFT); araştırma yönlendirme; denetim savunma dosyası; kapalı devre yazılım; veri gizliliği (KVKK)
...
Platformun çekirdeği, her hesabın mevzuat maddesine izlenebilir bağını koruyan, yürürlük tarihine göre sürümlenen kural setleriyle çalışan deterministik hesap motorudur. Yapay zekâ, alana özgü olarak ince ayarlanmış dar kapsamlı bir modelle iki işte kullanılır: belge alan çıkarımı önerisi ve **deterministik motorun ürettiği farkların yorumlanarak hangi ek detayın incelenmesi gerektiğinin önerilmesi.** Model **hesap yapmaz, karar vermez**; ürettiği her çıktı bir araştırma önerisidir, sonucu deterministik motor doğrular ve tüm öneriler insan onayından geçer. Ürün, internet bağlantısı olmayan (kapalı devre) ortamlardaki sıradan kişisel bilgisayarlarda, grafik işlemci gerektirmeden, yalnızca merkezi işlemciyle çalışır; bordro verisi kurum dışına hiçbir koşulda çıkmaz ve 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) yükümlülükleri tasarım düzeyinde karşılanır. Mevzuat güncellemeleri, elektronik imzalı çevrimdışı paketlerle dağıtılır.
...
5. **Sonuç yorumlama ve araştırma yönlendirme modeli (ay 10):** Deterministik motorun çıktısıyla üretilen denetim verisi üzerinde ince ayarlanan dar kapsamlı modelin, fark yorumlama ve araştırma yönlendirme görevindeki başarımı. *Metrik:* araştırma yönlendirme isabeti ≥%70 (önerilen belgenin, farkı gerçekten çözen belge olma oranı); ince ayarsız temel modele karşı ≥15 puan üstünlük; grafik işlemcisiz referans bilgisayarda öneri başına ≤30 saniye; model çıktısının tutar hesabına girmediğinin mimari olarak kanıtlanması. *Test seti:* eğitimde kullanılmamış kör fark envanteri + Yeminli Mali Müşavir etiketli doğrulama örneklemi.
...
*(c) Döngü nasıl kapanır?* Modelin çıktısı bir hesap değil, bir **araştırma önerisidir**: "şu dönemin şu belgesine bakılmalı", "şu hipotez şu kayıtla ayrıştırılabilir". Bu öneri üzerine ilgili detay getirilir, deterministik motor yeniden çalıştırılır ve sonuç modeli değil **motoru** doğrular. Model hiçbir aşamada hesap yapmaz veya karar vermez; yanlış bir öneri yalnızca gereksiz bir inceleme adımı doğurur, hatalı bir tutar üretmez. Bu asimetri, yapay zekânın denetim ortamında güvenle kullanılabilmesinin tasarım koşuludur ve projenin özgün mimari tercihidir.

*Ölçüt (ay 10):* İnce ayarlı modelin araştırma yönlendirme isabeti (önerilen belgenin farkı gerçekten çözen belge olma oranı) **≥%70**; aynı görevde ince ayarsız temel modele karşı en az **15 puan** üstünlük; 16 GB bellekli, grafik işlemcisiz referans bilgisayarda öneri başına süre **≤30 saniye**; **modelin ürettiği hiçbir çıktının tutar hesabına girmediği** mimari olarak kanıtlanır (kod düzeyinde ayrım ve denetim izi). Test seti: pilotların gerçek fark envanterinden ayrılan, eğitimde kullanılmamış kör küme + YMM etiketli doğrulama örneklemi.
...
**4. Yapay zekânın rolünün hesaplamadan araştırmaya kaydırılması.** Yaygın eğilim, mali ve hukuki hesaplamalarda üretken yapay zekânın karar üretici konumda kullanılmasıdır. Bu projede yapay zekâ **hesap yapmaz, karar vermez**; deterministik motorun sonucunu yorumlar ve hangi ek detayın araştırılması gerektiğini önerir. Ayrıca modelin eğitim verisi, doğrulanmış deterministik motorun kendi çıktısından üretilir — yani sistem kendi kullanımı sırasında kendi denetim verisini biriktirir. Her öneri deterministik doğrulama kapısından ve insan onayından geçer. Bu tercih, denetim savunulabilirliğinin ve 6698 sayılı Kanun uyumunun ön koşuludur; ürünün çıktısının denetim karşısında tekrarlanabilir olmasını sağlar.
