...
Argelog, 2013'ten bu yana sanayi kuruluşlarına inovasyon, teknoloji ve Ar-Ge yönetimi yazılımları ile yönetim danışmanlığı hizmeti sunmaktadır. Ürün ailesi üç modülden oluşur:

| Modül | Kapsam |
|---|---|
| Ar-Ge Yönetimi | Proje yönetimi, destek programı süreçleri, teknoloji hazırlık seviyesi takibi, faaliyet raporu altyapısı, 5746 uyum kontrolleri |
...
*Aşağıdaki tablo, son üç yılın bağımsız denetimden geçmiş veya yeminli mali müşavirce onaylı mali tablolarından doldurulur. Tablolar ayrıca PDF olarak eke iliştirilir.*
...
- [ ] İmza sirküleri
- [ ] Vergi levhası
- [ ] Son üç yıla ait mali tablolar (YMM onaylı veya bağımsız denetimden geçmiş)
- [ ] SGK borcu yoktur ve vergi borcu yoktur yazıları *(başvuru tarihinde güncel)*
- [ ] Varsa: kalite/bilgi güvenliği belgeleri (ISO 9001, ISO 27001 vb.)
- [ ] Varsa: daha önce alınan kamu destekleri ve tamamlanan projeler listesi
